...
|---|---|---|
| RNN with Attention for Machine Translation | Implements an encoder-decoder RNN with an attention mechanism for machine translation. | [Open in Colab](https://colab.research.google.com/github/YOUR_GITHUB_USERNAME/ai-engineering-labs/blob/main/modeling/rnn-attention-translation/seq2seq_translation.ipynb) |
| BERT Emotion Classification | Fine-tunes BERT on the EmpatheticDialogues dataset for emotion classification. | [Open in Colab](https://colab.research.google.com/github/YOUR_GITHUB_USERNAME/ai-engineering-labs/blob/main/modeling/bert-emotion-classification/BERT_Text_Classification.ipynb) |
| GPT-2 Text Summarization | Fine-tunes GPT-2 to generate summaries from article text. | [Open in Colab](https://colab.research.google.com/github/YOUR_GITHUB_USERNAME/ai-engineering-labs/blob/main/modeling/gpt2-summarization/summary_fine-tune_gpt2.ipynb) |
...
| Gemma Tool Calling | Implements tool schemas, function dispatching, weather lookup, web search, and tool-result feedback using Gemma 4. | [Open in Colab](https://colab.research.google.com/github/YOUR_GITHUB_USERNAME/ai-engineering-labs/blob/main/structured-output-tool-use/gemma4-tool-calling/gemma4_tool_calling.ipynb) |
